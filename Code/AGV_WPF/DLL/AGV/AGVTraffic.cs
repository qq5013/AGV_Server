...
namespace AGV_WPF.DLL.AGV
{
    ...
    public struct TrafficRetParam
    {
        public bool trafficResult;
        public int trafficNum;
        public TrafficRetParam(bool result, int num)
        {
    ...
    {
        //AGV运行控制
        public const bool AGVMODERUN = false;
        public const bool AGVMODESTOP = true;
